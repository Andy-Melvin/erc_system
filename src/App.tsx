      ...
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/youth/*" element={
            <ProtectedRoute allowedRoles={['Youth Committee']}>
              <YouthLayout>
                <Routes>
                  <Route index element={<YouthDashboard />} />
                  <Route path="calendar" element={<YouthCalendar />} />
                  <Route path="announcements" element={<YouthAnnouncements />} />
            ...
            <ProtectedRoute allowedRoles={['Pastor']}>
              <ChurchLayout>
                <Routes>
                  ...
                  <Route path="recommendations" element={<ChurchRecommendations />} />
                  <Route path="performance" element={<ChurchPerformance />} />
                  <Route path="endorsements" element={<ChurchEndorsements />} />
                </Routes>
              </ChurchLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/admin/access-codes" element={
            <ProtectedRoute allowedRoles={['Admin']}>
              <AdminLayout><div className="p-6">Access Codes (Coming Soon)</div></AdminLayout>
            </ProtectedRoute>
          } />
          <Route path="/admin/reports" element={
            <ProtectedRoute allowedRoles={['Admin']}>
              <AdminLayout><div className="p-6">Reports (Coming Soon)</div></AdminLayout>
            </ProtectedRoute>
          } />
