...
export function UserRegistrationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.full_name || !formData.email || !formData.role || !formData.gender) {
      toast({
    ...
    try {
      ...
      if (data?.success) {
        toast({
          ...
          description: `Access code: ${data.access_code}. Please share this with the user.`,
        });
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.family_category} onValueChange={(value) => handleInputChange('family_category', value)}>
                <SelectTrigger>
