...
import { MoreHorizontal, Plus, Edit, Trash2, Users, Calendar } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const memberData = {
        ...
        bcc_class: formData.bcc_class || null,
        grad_year: formData.grad_year ? parseInt(formData.grad_year) : null,
        grad_mode: formData.grad_mode || null,
        parental_status: formData.parental_status || null,
      };
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, bcc_class: e.target.value})}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setFormData({...formData, grad_mode: e.target.value})}
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.parental_status} onValueChange={(value) => setFormData({...formData, parental_status: value})}>
                    <SelectTrigger className="rounded-xl">
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="hidden lg:table-cell">BCC Class</TableHead>
            ...
            <TableBody>
              {members.map((member) => (
                <TableRow key={member.id}>
                  <TableCell>
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Age: {calculateAge(member.dob)} • {member.gender || "Not specified"}
                      </p>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <div>
                      <p className="text-sm font-medium">{member.education || "Not specified"}</p>
                      <p className="text-xs text-muted-foreground">{member.employment || "Not specified"}</p>
                    </div>
                  </TableCell>
                  <TableCell className="hidden lg:table-cell">
                    <div>
                      <p className="text-sm">{member.bcc_class || "Not assigned"}</p>
                      <p className="text-xs text-muted-foreground">
                        {member.grad_year ? `Graduating ${member.grad_year}` : "No graduation info"}
                      </p>
                    </div>
                  </TableCell>
